...
In a preliminary interview study, we discovered that man game designers are working with digital whiteboards, for good reasons. The user interface of pix:e has many entry points that naturally work with this type of workflow. In this thesis, you are updating the user interface of pix:e to more closely resemble that of digitial whiteboards like Miro or Figjam.

### Data Visualizataion
Keywords: Diagrams, Frontend, Nuxt4, Vuejs

pix:e uses a pathfinding algorithm similar to [PaceMaker] to find paths through the designed space. Currently, it only allows to visualize simple line diagrams. This thesis includes extending this visualization with everything that might be of interest based on an initial research phase. A focus of this is going to be implementing Pacing Diagrams based on this [PacingDiagrams] paper.

### SPARC & PILLAR Upgrades
Keywords: Full-stack, Nuxt4, Django
...
Keywords: Python, LLMs, Data Analysis
Bonus: Co-authorship likely

We analyzed 100.000 steam reviews and extracted player expectations. Player expectations help developers understand what players expect of a given genre or type of game. This thesis continues this work and cleans up the results. 

### Game Designer Interview Study (Bachelor / Guided Research)
Keywords: Interview, User Study
Bonus: Co-authorship highly likely
...
[SPINE]: https://dl.acm.org/doi/full/10.1145/3815598.3815653
